...
<section data-page="rental-agreements" class="max-w-4xl mx-auto">
    <div class="bg-white border border-border rounded-card shadow-card p-6 text-center space-y-4">
        ...
        <h1 class="text-2xl font-semibold">Rental Agreements</h1>
        <p class="text-gray-600">Rental agreement records are coming soon.</p>
        <p class="text-sm text-gray-500">We'll add creation, tracking, and document storage for rental agreements here.</p>
    </div>
</section>
